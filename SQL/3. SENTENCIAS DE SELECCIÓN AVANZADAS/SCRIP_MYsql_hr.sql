CREATE DATABASE MYSQL_HR;
 ...
 CREATE TABLE regions
  ...
  CREATE TABLE countries 
    ...
    ALTER TABLE LOCATIONS MODIFY CITY VARCHAR(30) NOT NULL;
    ALTER TABLE LOCATIONS MODIFY STATE_PROVINCE VARCHAR(25);
